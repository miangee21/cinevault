...
export function Navbar() {
  ...
  const handleLogout = async () => {
    try {
      ...
      toast.success("Logged out successfully", {
        description: "You have been securely signed out of Cinevault.",
      });
    } catch {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/50 bg-background/95 backdrop-blur-md shadow-sm h-12 flex items-center">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 w-full grid grid-cols-[1fr_auto_1fr] items-center">
        <Link
          href="/dashboard"
